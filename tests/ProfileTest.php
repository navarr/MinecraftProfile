...
class Tests extends PHPUnit_Framework_TestCase
{
    ...
    private function asserts(Profile $profile) {
        ...
        $this->assertEquals('http://textures.minecraft.net:8080/texture/95a2d2d94942966f743b84e4c262631978253979db673c2fbcc27dc3d2dcc7a7', $profile->capeUrl);
        $this->assertEquals('http://textures.minecraft.net:8080/texture/5112ebb7f5d7bdc5b57532af14408fbb757692ad81cc717e4c1faecdb9e3a2b5', $profile->skinUrl);
    }
}
